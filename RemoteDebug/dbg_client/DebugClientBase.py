...
##        printerr(line)          ##debug
    ...
    def __formatQt4Variable(self, value, vtype):
        ...
        if qttype == 'QString':
            ...
            varlist.append(("", "QDate", "%s" % unicode(str(value))))
        elif qttype == 'QTime':
            varlist.append(("", "QTime", "%s" % unicode(str(value))))
        elif qttype == 'QDateTime':
            varlist.append(("", "QDateTime", "%s" % unicode(str(value))))
        elif qttype == 'QDir':
            ...
            varlist.append(("url", "QString", "%s" % unicode(str(value))))
        ...
        # GUI stuff
            ...
            varlist.append(("shortcut", "QString", "%s" % \
                unicode(str(value.shortcut()))))
        elif qttype == 'QKeySequence':
            varlist.append(("value", "", "%s" % unicode(str(value))))
        ...
        # XML stuff
            ...
            varlist.append(("text", "QString", "%s" % unicode(str(value))))
        ...
        # Networking stuff
            ...
            varlist.append(("address", "QHostAddress", "%s" % unicode(str(value))))
